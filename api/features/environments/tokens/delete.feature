Feature: Delete token from my environment
  ...
  Scenario: Delete my environment
    Given I am logged in
    Then should have a field tokens with length 1
    When I make a "GET" request to "/environments/e0000004-0000-0000-0000-000000000000/tokens/e0000002-0000-0000-0000-t00000000001"
