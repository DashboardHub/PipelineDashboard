Feature:  Display public projects on the homepage
  ...
  Scenario: List public project on the homepage with minimum information
    ...
    Then the text "0" is in the row
    And the text "0" is in the row
    And the text "0" is in the row
    #And the text "test-user-minimum" is in the row
    And the text "1 second ago" is in the row
  ...
  Scenario: List public project on the homepage with repository and monitor
    ...
    Then the text "Test public project with full data description" is in the row
    And the text "https://www.pipelinedashboard.io" is in the row
    And the text "1" is in the row
    And the text "1" is in the row
    And the text "0" is in the row
    #And the text "test-user-minimum" is in the row
    And the text "1 second ago" is in the row
