...
export class ProjectsListComponent implements OnChanges {
  ...
  constructor(
    ...
    this.breakpointObserver
      ...
      .subscribe((state: BreakpointState) => {
        if (state.matches) {
          ...
          this.displayedColumns = ['type', 'alert', 'title', 'description', 'url', 'repository', 'monitors', 'pings', 'user', 'lastDate', 'actions'];
        } else {
          this.isSmallScreen = false;
          this.displayedColumns = ['type', 'alert', 'title', 'description', 'url', 'repository', 'monitors', 'pings', 'user', 'lastDate', 'actions'];
        }
    ...
    this.breakpointObserver
      ...
      .subscribe((state: BreakpointState) => {
        if (state.matches) {
          this.displayedColumns = ['type', 'alert', 'title', 'description', 'url', 'repository', 'monitors', 'pings', 'actions'];
          this.isSmallScreen = false;
        }
      });
    this.breakpointObserver
