...
export const pingMonitor: HttpsFunction = functions.https.onCall((input: MonitorInfoInput, context: CallableContext) => getMonitorPings(input.token, input.projectUid, input.monitorUid));
